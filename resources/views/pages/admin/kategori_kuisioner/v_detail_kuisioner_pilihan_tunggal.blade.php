...
@section("title", "Data Point Pilihan Tunggal")
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url('/admin/kategori_kuisioner/'.$detail->kategori_kuisioner_id) }}">
                                Detail Kategori Kuisioner
                            </a>
                        </li>
                        <li class="breadcrumb-item active">
                            Point Pilihan Tunggal
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap table-striped" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th>Nama Point</th>
                                <th class="text-center">Punya Point</th>
                                <th class="text-center">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($point_pilihan_tunggal as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="{{ url('/admin/point_pilihan_tunggal/'.$item["id"]) }}" method="POST" style="display: inline">
                                            @csrf
                                            @method("DELETE")
...
<div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ url('/admin/point_pilihan_tunggal') }}" method="POST">
                @csrf
                <div class="modal-body">
                    ...
                    <br>
                    <div class="form-group">
                        <label for="is_child"> Ada Point ? </label>
                        <select name="is_child" class="form-control @error("is_child") {{ 'is-invalid' }} @enderror " id="is_child">
                            <option value="">- Pilih -</option>
                            <option value="1" {{ old('is_child') == 1 ? 'selected' : '' }} >YA</option>
                            <option value="0" {{ old('is_child') == 0 ? 'selected' : '' }} >TIDAK</option>
                        </select>
                    </div>
                    @error("is_child")
                        <span class="text-danger">
...
<div class="modal fade bs-example-modal-center-edit-{{ $item["id"] }}" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ url('/admin/point_pilihan_tunggal/'.$item["id"]) }}" method="POST">
                @csrf
                @method("PUT")
                <div class="modal-body">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_child" class="form-control @error("is_child") {{ 'is-invalid' }} @enderror " id="is_child">
                            <option value="">- Pilih -</option>
                            @if (old("is_child") === "1" || (isset($item) && $item["is_child"] === "1" ) )
                            <option value="1" selected>YA</option>
                            <option value="0">TIDAK</option>
                            @elseif(old("is_child") === "0" || (isset($item) && $item["is_child"] === "0" ) )
